...
class WC_Gateway_XPay_Apple_Pay_Button_Blocks_Support extends WC_Gateway_XPay_Blocks_Support
{
    ...
    {
        parent::__construct('applepay_button');
    ...
    {
        return [
            'enabled' => \Nexi\WC_Gateway_Nexi_Register_Available::is_xpay_recurring($this->apm) && \Nexi\WC_Nexi_Helper::cart_contains_subscription(),
