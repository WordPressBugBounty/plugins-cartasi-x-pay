...
class WC_Gateway_NPG_Cards_Build_Blocks_Support extends AbstractPaymentMethodType
{
    ...
    {
        $baseFilename = 'index_xpay_npg_build';
    ...
    public function get_payment_method_data()
    {
        ...
        return [
            ...
            'validation_error' => __('Incorrect or missing data', 'woocommerce-gateway-nexi-xpay'),
            'session_error' => __('XPay Build session expired', 'woocommerce-gateway-nexi-xpay'),
            'admin_url' => admin_url(),
            'icons' => $this->getIcons(),
