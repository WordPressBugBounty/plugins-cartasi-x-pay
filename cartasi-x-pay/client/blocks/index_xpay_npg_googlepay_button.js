...
const getPaymentMethodConfiguration = () => {
    const serverData = wc?.wcSettings?.getSetting("xpay_npg_googlepay_button_data", null);

    if (!serverData) {
        throw new Error("xpay_npg_googlepay_button initialization data is not available");
    }
...
const getPaymentMethodOptions = () => {
    ...
    const options = {
        name: "xpay_npg_googlepay_button",
